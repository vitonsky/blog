---
title: "Open source product is a marketing tool"
date: '24/06/2025, 21:50'
image: slc-punk.png
tags:
  - opensource
  - marketing
...
<figure>
  ...
  <figcaption>SLC Punk! The movie</figcaption>
</figure>
...
Most of them end up disappointed, because the results are not worth the efforts. I believe it's because of a wrong approach to project development, specifically incorrect project goals and project positioning.

## Open source gives no money

Reality check #1 - open source does not pay developers. It only enriches companies. The hype around billions in open source revenue ignores where the money actually goes.
...
If you push your pain-fixing open source tool to the right crowd early, it *might* gain traction.
...
As I said, donations in open source projects are too small to motivate developers to do anything. $10 or $100 is not enough to drive development.

If you love an open source project, don’t throw a few bucks and move on. Spread the word — your voice is worth more than any donation.
