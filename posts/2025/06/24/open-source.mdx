...
Programmers believe that it is enough to make a cool project, then people will discover it on their own, will like it and start using it, will pay for it, spread the word about the product. Maybe it's because they have seen too many cool stories of influencers on Twitter and believe it is true.
...
As I said, donations in open source projects are too small to motivate developers to do anything. $10 or $100 is not enough to drive development. So if you find some nice open source project, keep your money and spread the word about it.
