...
import Subscribe from '../../astro/src/features/Subscribe.astro'
...
I'm **founder** at [PrimeBits](https://primebits.org), a B2B software engineering team, and sometimes I write posts with my reflections and insights about [#management](/blog/tag/management/). These are my vision and advice on how to build processes in teams to make them efficient.
...
You can follow updates by subscribing to [RSS](/rss.xml), [Twitter](https://twitter.com/rvitonsky), [Bluesky](https://bsky.app/profile/vitonsky.bsky.social) or [Mastodon](https://mastodon.social/@vitonsky).

I send a newsletter whenever there's something worth reading. No cadence, no growth hacks, no filler. If that sounds like your kind of inbox, the form is below.

<Subscribe/>

# Contact

If you want to share something interesting, you can send it to me via <a href="mailto:robert@vitonsky.net" rel="me">email</a>.
