...
export default {
	...
	footer: [
		...
		},
		{
			title: 'Feeds',
			description:
				"Not all things goes to my blog. I share findings on my feeds, let's be in touch",
			links: [
				{
					text: 'Twitter',
					url: 'https://twitter.com/rvitonsky',
					target: '_blank',
				},
				{
					text: 'BlueSky',
		...
		},
		{
			...
			links: [
				...
				{
					text: 'LinkedIn',
					url: 'https://www.linkedin.com/in/vitonsky',
					target: '_blank',
				},
				{
					text: 'StackOverflow',
					url: 'https://stackoverflow.com/users/18680275/vitonsky',
					target: '_blank',
				},
			],
		},
